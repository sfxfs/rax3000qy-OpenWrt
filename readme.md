...
**注意！** 本文介绍的获取权限方法可能会随着系统更新**失效**，如果发现无法取得权限，请查看本仓库 [issue](https://github.com/sfxfs/rax3000qy-OpenWrt/issues) 和 [其他教程](https://hugo.utermux.dev/default/rax3000q-latest/) 或自行搜索其他方法。
